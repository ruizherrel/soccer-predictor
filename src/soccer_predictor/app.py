...
_FEATURE_LABEL_TEMPLATES = {
    ...
    "home_venue_gf_last5": "{unit} a favor de {home} jugando de local (últimos 5 de local)",
    "home_venue_ga_last5": "{unit} en contra de {home} jugando de local (últimos 5 de local)",
    "home_venue_gf_last10": "{unit} a favor de {home} jugando de local (últimos 10 de local)",
    "home_venue_ga_last10": "{unit} en contra de {home} jugando de local (últimos 10 de local)",
    "away_venue_gf_last5": "{unit} a favor de {away} jugando de visitante (últimos 5 de visita)",
    "away_venue_ga_last5": "{unit} en contra de {away} jugando de visitante (últimos 5 de visita)",
    "away_venue_gf_last10": "{unit} a favor de {away} jugando de visitante (últimos 10 de visita)",
    "away_venue_ga_last10": "{unit} en contra de {away} jugando de visitante (últimos 10 de visita)",
